...
// };
// exports.swipe = function (opts) {
//     var action = new wd.TouchAction(opts.driver);
//     action
//       .press({x: opts.startX, y: opts.startY})
//       .wait(opts.duration)
//       .moveTo({x: opts.offX || 0, y: opts.offY || 0})
//       .release();
//       return action.perform();
// };

exports.swipe = function({driver,startX = 0,startY = 0,offX = 0,offY = 0,duration = 200}) {
...
exports.tapLocation = function (opts) {
  var action = new wd.TouchAction(opts.driver);
  action.tap({x: opts.x , y: opts.y})
  return action.perform();
};
