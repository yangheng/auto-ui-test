if (process.env.DEV) {
  ...
  exports.iosYSPApp = "sample-code/apps/WebViewApp/3.0.0.ipa"
} else {
  ...
  exports.iosYSPApp = "/Users/adminyunshipeicom/Documents/sample-code-newAppTest/sample-code/apps/WebViewApp/3.0.0.ipa"
